...
> [Apple](bugs.md) has built a reputation for prioritizing user [pri](https://heinonline.org/HOL/LandingPage?handle=hein.journals/walq99&div=26&id=&page=)[va](privacy.pdf)[confidentiality.pdf](cy) and [sec](https://ieeexplore.ieee.org/abstract/document/9066964)[urity](confidentiality.pdf)
